...
BirdController::BirdController(int jump_button_code, float jump_y_speed, float max_y_speed) : jump_button_code_(
        jump_button_code),
                                                                                              jump_y_speed_(
                                                                                                      jump_y_speed),
                                                                                              max_y_speed_(
...
void BirdController::Update(float dt) {
    auto jump_pressed = is_key_pressed(jump_button_code_);
